											...
											<div class="portlet-body form">
												<div class="form-body">
													<div class="form-group">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_first_name" id="customer_first_name" class="form-control" placeholder="Enter First Name">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_last_name" id="customer_last_name" class="form-control" placeholder="Enter Last Name">
													...
													<div class="form-group">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_email" id="customer_email" class="form-control" placeholder="Enter Email-Id">
													      <div id="customer_email_error" style="font-size:12px; color:red; font-weight:700;"></div>
													   </div>
													
													   <label  class="col-md-3 control-label">Password:</label>
													   <div class="col-md-3">
														  <input type="text" name="customer_password" id="customer_password" class="form-control" placeholder="Enter Password">
													...
													<div class="form-group">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_number" id="customer_number" class="form-control" placeholder="Enter Last Name">
											...
											<div class="portlet-body form">
												<div class="form-body">
													<div class="form-group">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_address1" id="customer_address1" class="form-control" placeholder="Enter Address">
														  <div id="customer_address1_error" style="font-size:12px; color:red; font-weight:700;"></div>
													   </div>
													
													   <label  class="col-md-3 control-label">Address 2:</label>
													   <div class="col-md-3">
														  <input type="text" name="customer_address2" id="customer_address2" class="form-control" placeholder="Enter Address">
													...
													<div class="form-group">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_landmark" id="customer_landmark" class="form-control" placeholder="Enter Company Name">
													...
													<div class="form-group">
													   ...
													   <div class="col-md-3">
														  <input type="text" name="customer_pincode" id="customer_pincode" class="form-control" placeholder="Enter Pincode">
													      <div id="customer_pincode_error" style="font-size:12px; color:red; font-weight:700;"></div>
													   </div>
													
													   <label  class="col-md-3 control-label">Company:</label>
													   <div class="col-md-3">
														  <input type="text" name="customer_company" id="customer_company" class="form-control" placeholder="Enter Company Name">
...
$.ajax({
url: "add.php", // Url to which the request is send
